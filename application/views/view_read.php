...
<!--////////////////////////////GRADES STATISTIC////////////////////////////////// -->
		...
		<tr>
			<td>
				<h3 style="color:red"><?=$this->form_2['vote_message']?></h3>
			</td>
		</tr>
		<?php } else { ?>
		<tr>
		...
		<tr>
			...
			<td>
				<form action="<?="/site/" . $lang . "/read/delete_grade"?>" method="post">
					<div><input type="submit" name="delete_grade" value="<?=$this->form_2[delete_grade_button]?>"/>
					<input type="hidden" name="login" value="<?=$_SESSION['login']?>"/>
					<input type="hidden" name="article_id" value="<?=$article[0]['id']?>"/></div>
				</form>
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<table align="center" width="600">
				...
				<form action="<?="/site/" . $lang . "/read/delete_comment"?>" method="post">
					<div>
					<input type="submit" name="delete" value="<?=$this->form_2[delete_comment_button]?>"/>
		...
		<tr>
			...
			<table border="1" style="margin:0 auto 0 auto">
				...
				<tr>
					<td align="center">
						<textarea cols="80" rows="10" name="comment_text" required="required"></textarea>
					</td>
				</tr>
				<tr>
