...
<body>
	<table width="800" style="margin:0 auto 0 auto">
		<tr>
		...
		<tr>
			<td style="border-width:645px">
				<h1 style="text-align:center"><?=View::$lang_array['template_page']['site_name']?></h1>
			</td>
			<td width="155">	
		...
		<tr> 
			<td colspan="2" align="center">
				<form action="<?=$lang . "/add"?>" method="post">
					...
					value="<?=View::$lang_array['template_page']['add_button']?>"/></div>
				</form>
			</td>
		</tr>
		<?php } ?> 
